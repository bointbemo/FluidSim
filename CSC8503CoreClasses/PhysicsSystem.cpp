...
void PhysicsSystem::ImpulseResolveCollision(GameObject& a, GameObject& b, CollisionDetection::ContactPoint& p) const {
	...
	const CollisionVolume* VolumeA = a.GetBoundingVolume();
	const CollisionVolume* VolumeB = b.GetBoundingVolume();

	if (VolumeA->type == VolumeType::Fluid || VolumeB->type == VolumeType::Fluid) {
		return;
	}
...
void PhysicsSystem::ResolveFluidInteraction() {
	return;
}
/*
