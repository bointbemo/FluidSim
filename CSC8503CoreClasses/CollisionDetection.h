...
namespace NCL {
	...
	public:
		...
		static bool RayFluidIntersection(const Ray& r, const Transform& worldTransform, const FluidVolume& volume, RayCollision& collision);
		bool FluidAABBIntersection(const AABBVolume& volumeA, const Transform& worldTransformA, const FluidVolume& volumeB, const Transform& worldTransformB, CollisionInfo& collisionInfo);
